...
<main id="gallery">
<div class="main-img">
<img src="dashnoard/images/<?php echo $images[0] ?>" id="current" alt="#">
</div>
<div class="images">
<?php 
    foreach ($images as $key => $value) { ?>
     <img src="dashnoard/images/<?php echo $value ?>" id="current" alt="#">
   <?php }
?>
</div>
</main>
...
<p class="category"><i class="lni lni-tag"></i> <?php echo $product['category'] ?> <a href="javascript:void(0)"><?php echo $product['category'] ?></a></p>
<h3 class="price"><?php echo $product['price'] ?><span><?php echo $product['sale'] ?></span></h3>
...
<button class="btn _cart" pro-id="<?php echo $id ?>" style="width: 100%;">Add to Cart</button>
</div>
</div>
<div class="col-lg-4 col-md-4 col-12">
